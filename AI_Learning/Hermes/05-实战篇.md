...
| 序号 | 功能 | 所属模块 | 使用场景 |
|------|------|---------|---------|
| 1 | **Profile** | [[04-协作篇|协作篇]] | 创建 researcher、writer、reviewer、publisher 四个角色 |
| 2 | **Provider** | [[01-入门篇|入门篇]] | researcher 用 DeepSeek（便宜），writer 用 Claude（质量） |
| 3 | **Skills** | [[03-进化篇|进化篇]] | 安装 blogwatcher；writer 加载写作风格 skill |
| 4 | **skill_manage** | 进化篇 | writer Agent 自动沉淀「技术博文写作规范」skill |
| 5 | **Curator** | 进化篇 | 维护自动生成的写作 skill，合并重复模板 |
| 6 | **Memory** | [[02-能力篇|能力篇]] | 记住博客 Markdown 风格偏好、发布平台 API 配置 |
